...
L = 1;            % Working on [0, L]
num_sites = 1000;
00; % Total number of sites in [0, L] x [0, L]
...
folderName = 'small_fires_sigma_B=0.05';
mkdir(folderName);
...
beta_F = 1 * 10^4;    % Rate of fire spread through forest
beta_G = 5 * 10^4;    % Rate of fire spread through grass
gamma = 500;     % Rate of grass regrowth from ash
q = 2 * 10^4;         % Fire quenching rate

mu = 0.01;       % Rate of tree death due to non-fire causes

sigma_P = 0.03;   % width of Gaussian of forest seeding
...
%g0 = 0;
g1 = 0.1;         % Grass burning sigmoid upper bound
%g1 = 0;
...
saveas(gcf, [folderName '/cover_proportions' num2str(15) '.jpeg']);
saveas(gcf, [folderName '/cover_proportions' num2str(15) '.fig']);
