...
LineDefaultCell = {
    ...
    '-',colorRed,3,'none',6,colorRed,colorNone,5,'EP-';
    [2 0],'Unstable Equilibria',...
    '-',colorBlack,3,'none',6,colorBlack,colorNone,5,'EP+';
    [3 0],'Stable Periodic Orbits',...
    '-',colorGreen,3,'none',6,colorNone,colorGreen,5,'PO-';
    [4 0],'Unstable Periodic Orbits',...
    '-',colorBlue,3,'none',6,colorBlue,colorNone,5,'PO+';
    [2 5],'Branch Points',...
    '-',colorOlive,3,'none',6,colorOlive,colorNone,5,'BP';
    [2 3],'Hopft Bifurcation',...
    '-',colorBlue,3,'none',6,colorBlue,colorNone,5,'HB';
    [2 1],'Limit Points',...
    '-',colorRed,3,'none',6,colorRed,colorNone,5,'LP';
    [4 7],'Periodic Orbits',...
    '-',colorYellow,3,'none',6,colorYellow,colorNone,5,'PO';
    [2 6],'Periodic Doubling',...
    '-',colorOlive,3,'none',6,colorOlive,colorNone,5,'PD';
    [2 2],'Saddle-Node Limit Cycles',...
    '-',colorBlack,3,'none',6,colorBlack,colorNone,5,'SNLC';
    [NaN NaN],'Unknown Type',...
    '-',colorBlack,3,'none',6,colorBlack,colorNone,5,'??';
    };
