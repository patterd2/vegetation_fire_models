...
beta_G = 1000000;    % Rate of fire spread through grass
gamma = 10;     % Rate of grass regrowth from ash
q = 5000;         % Fire quenching rate
...
% Initialize states of sites - one square fire patch at [0.45L, 0.55L] x [0.45L, 0.55L]
for i = 1:num_sites
...
% Save parameters
save([folderName '/parameters.mat'], 'L', 'num_sites', 'T', 'dt', 'dx', 'dy', 't0', ...
